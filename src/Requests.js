...
const requests = {
    ...
    fetchTopRated: `/trending/all/week?api_key=${TMDB_KEY}&language=en-US`,
...
// https://api.themoviedb.org/3/discover/movie?api_key=f81980ff410e46f422d64ddf3a56dddd&with_genres=27